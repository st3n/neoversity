...
class Parser:
    ...
    def factor(self):
        """Parser for factors, which are integers or expressions in parentheses."""
    ...
    def term(self):
        """Parser for terms, which are factors combined by * or /."""
        node = self.factor()
    ...
    def expr(self):
        """Parser for expressions, which are terms combined by + or -."""
        node = self.term()
...
def main():
    #while True:
        ...
        #        break
            ...
            interpreter = Interpreter(parser)
            result = interpreter.interpret()
            print(f'{text3} = {result}')
            lexer = Lexer(text4)
            parser = Parser(lexer)
            interpreter = Interpreter(parser)
            result = interpreter.interpret()
            print(f'{text4} = {result}')
